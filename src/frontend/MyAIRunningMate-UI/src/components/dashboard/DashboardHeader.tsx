...
export const DashboardHeader = ({ latestWeight }: DashboardHeaderProps) => {
  return (
    <div className="flex justify-between items-center border-b border-slate-800 pb-6">
      ...
      {/* Right Side: Grouped Metrics */}
      <div className="flex items-center gap-4">
        <div className="bg-slate-900/50 p-3 px-6 rounded-2xl border border-slate-800">
          <p className="text-[10px] text-slate-500 uppercase font-black tracking-widest text-right">V02 Max</p>
          <p className="text-2xl font-black text-blue-400 italic">
            48.5
            <span className="text-xs text-slate-600 not-italic ml-1">ML/KG</span>
          </p>
        </div>
